                        ...
                        <tr key={student.id} className="hover:bg-muted/50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div
                                className={`h-10 w-10 rounded-full bg-muted flex items-center justify-center ${student.profile_image_url ? "hidden" : ""
                                  }`}
                              >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <span
                                className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${student.package === "gold"
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <span
                                className={`text-sm ${student.is_active
                                    ? "text-emerald-400"
                                    : "text-red-400"
                                  }`}
                              >
          ...
          <div className="bg-card border border-border rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-4rem)]">
              ...
              <div className="flex justify-center mb-6">
                ...
                <div
                  className={`h-24 w-24 rounded-full bg-muted flex items-center justify-center border-4 border-border shadow-lg ${selectedStudent.profile_image_url ? "hidden" : ""
                    }`}
                >
